...
export interface mat3 extends num3x3 {
...
export const mat3 = implementType({
    ...
    fromCols(x: num3, y: num3, z: num3, out = create()): mat3 {
        return this.set(out,
            x.x, x.y, x.z,
            y.x, y.y, y.z,
            z.x, z.y, z.z);
    ...
    fromDiagonal(diagonal: num3, out = create()): mat3 {
        return this.set(out,
            diagonal.x, 0, 0,
            0, diagonal.y, 0,
            0, 0, diagonal.z);
    ...
    fromAxisAngle(axis: num3, radians: number, out = create()): mat3 {
    ...
    fromTranslation(translation: num2, out = create()): mat3 {
        return this.fromCols(
            vec3.right(),
            vec3.up(),
    ...
    fromScale(scale: num2, out = create()): mat3 {
    ...
    fromScaleAngleTranslation(scale: num2, radians: number, translation: num2, out = create()): mat3 {
        let [sin, cos] = sincos(radians);
        return this.fromCols(
    ...
    vmul3(lhs: mat3, rhs: num3, out = vec3()): num3 {
    ...
    col(self: mat3, index: number): num3 {
        switch (index) {
    ...
    row(self: mat3, index: number): num3 {
        switch (index) {
    ...
    transformPoint2(self: mat3, rhs: num2, out = vec2()): num2 {
    ...
    transformVec2(self: mat3, rhs: num2, out = vec2()): num2 {
